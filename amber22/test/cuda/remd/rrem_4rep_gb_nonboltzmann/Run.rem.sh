...
#TEST-DESCRIP Four replica GB NB Reservoir REMD.
...
. ../CudaRemdCommon.sh
Title "Four replica GB NB Reservoir REMD test."
...
$DO_PARALLEL $TESTsander -O -ng 4 -groupfile groupfile -rem 1 -remlog rem.log -rremd 2 -reservoir reservoir.nc
CheckError $? "${0}"
