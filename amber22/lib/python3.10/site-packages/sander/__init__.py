...
class setup(object):
    ...
    def __init__(self, prmtop, coordinates, box, mm_options, qm_options=None):
        ...
        elif not isinstance(prmtop, str):
    ...
    # A sander context is True IFF a system is set up. Otherwise it evaluates to boolean False
    def __bool__(self):
        return is_setup()
    ...
    def __repr__(self):
        ...
        has_pbc = all(box)
        if has_pbc:
            return '<SANDER Context; natom=%d; box=%s>' % (self.natom, box)
        else:
