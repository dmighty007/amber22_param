...
cat > nvein << EOF
Constant energy dynamics of dimethylether
 &cntrl
 ...
 /
EOF
$DO_PARALLEL $sander -O -i nvein -p ../../../virtual_sites/DimethylEther/prmtop_type8 \
                     -c ../../../virtual_sites/DimethylEther/eqrst -o nve.type8 || goto error
		     
grep "Etot" nve.type8 > etot.type8
cp etot.type8 etot.type8_$1.save
