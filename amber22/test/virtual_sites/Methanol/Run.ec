...
Constant volume and energy dynamics of bromobenzene
 ...
 &end
EOF
$DO_PARALLEL $sander -O -i nvein -p prmtop_type10 -c eqrst -o nve.type10 || goto error

grep "Etot" nve.type10 > etot.type10

$AMBERHOME/test/dacdif etot.type10.save etot.type10

/bin/rm -f nvein nve.type10
