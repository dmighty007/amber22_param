...
#TEST-DESCRIP Two replica GB NB Reservoir REMD.
...
. ../CudaRemdCommon.sh
Title "Two replica GB NB Reservoir REMD test."
...
$DO_PARALLEL $TESTsander -O -ng 2 -groupfile groupfile -rem 1 -remlog rem.log -rremd 2 -reservoir reservoir.nc
CheckError $? "${0}"
