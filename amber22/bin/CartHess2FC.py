...
parser.set_defaults(softv='gau', method='sem', scalef=1.000)
...
parser.add_option("-v", dest="softv", type='string',
                  help="Software version [Default is gau (means Gaussian). "
                       "Other options are g03 (means Gaussian03), g09 (means "
                       "Gaussian09), g16 (means Gaussian16), and gms (means "
                       "GAMESS-US)]. The options g03, g09, and g16 are all "
                       "equal to gau but kept for backward compatibility.")
parser.add_option("-m", dest="method", type='string',
                  help="Method used. [Default is sem (means Seminario, "
                       "applicable to g03, g09, g16, gau, and gms) other "
                       "option is zmx (means Z-matrix, only applicable to "
                       "g03, g09, g16, and gau.)]")
