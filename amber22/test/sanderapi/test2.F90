...
program test_program
    ...
    ! FIXME: Need to explicitly set ipol=0 in this case.
    ! For an unknown reason, I (Hai)
    ! kept getting 'GB/PB calculations are incompatible with polarizable force fields'
    ! This error message is from sander/cppparm.F90 (cpparm1 subroutine)
    parm%ipol = 0
